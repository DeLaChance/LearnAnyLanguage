 ...
 */
let PracticeList = /** @class */ (() => {
    var PracticeList_1;
    let PracticeList = PracticeList_1 = class PracticeList {
        getID() {
            return this.id;
        }
        static newEmptyList(sourceLanguage, targetLanguage, name) {
            let practiceList = new PracticeList_1();
    ...
    PracticeList = PracticeList_1 = __decorate([
        typeorm_1.Entity()
    ], PracticeList);
    return PracticeList;
})();
